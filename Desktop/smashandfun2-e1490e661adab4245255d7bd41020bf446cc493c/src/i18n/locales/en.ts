  ...
  terms: {
    ...
    sections: {
      general: {
        ...
        content: [
          "1.1. These Terms and Conditions define the rules for using the services provided by Smashandfun Sp. z o.o., hereinafter referred to as the 'Service Provider', with its registered office in Warsaw at ul. Postępu 19/4, 02-676 Warsaw, NIP: XXX, REGON: XXX, KRS: XXX.",
          "1.2. The rage room is an entertainment facility where Participants can release negative emotions in a controlled and safe manner by destroying designated items.",
      ...
      services: {
        ...
        content: [
          "2.1. Smashandfun offers the following services:",
          "a) Rage room access with equipment in various time packages",
          "b) Organization of special events (birthdays, bachelor/bachelorette parties)",
          "c) Organization of corporate events and team building",
          "d) Sale of gift vouchers",
          "2.2. Basic packages include:",
          "a) BASIC Package: 25 glass items, duration 30 minutes",
          "b) STANDARD Package: 35 glass items, 2 pieces of furniture, duration 45 minutes",
          "c) PREMIUM Package: 45 glass items, 3 pieces of furniture, 2 electronic devices, duration 60 minutes",
          "d) GROUP Package: individually arranged content for groups over 6 people",
          "2.3. Each package includes:",
          "a) Protective equipment (coverall, helmet with visor, gloves)",
          "b) Safety instruction",
          "c) Supervision of qualified personnel",
      ...
      reservations: {
        ...
        content: [
          ...
          "b) Providing contact details",
          "c) Reading and accepting the terms and conditions",
          "d) Making payment",
          "3.3. Age requirements:",
          "a) Adults (18+) - no additional requirements",
          "b) Ages 16-17 - written consent from legal guardian required",
          "c) Under 16 - not allowed to use services",
          "3.4. Reservation is valid after:",
          "a) Receiving confirmation from the Service Provider",
          "b) Making required payment within the specified timeframe",
          "3.5. The Service Provider may refuse to accept a reservation in case of:",
          "a) No available time slots",
          "b) Incomplete payment",
          "c) Suspicion of actions contrary to the regulations",
      ...
      payments: {
        ...
        content: [
          "4.1. Service prices:",
          "a) Are expressed in Polish zloty (PLN)",
          "b) Include VAT",
          "c) Are in accordance with the current price list available on the website",
          ...
          "- Cash",
          "4.3. Payment rules:",
          "a) Online reservation - 100% prepayment required",
          "b) Phone reservation - prepayment or payment at premises possible",
          "c) In-person reservation - payment at premises",
          "4.4. VAT invoices:",
          "a) Issued upon customer request",
          "b) Request must be made before payment",
          "c) Invoice details must be provided during reservation",
          "4.5. Gift vouchers:",
      ...
      rules: {
        ...
        content: [
          "6.1. Participant obligations before session:",
          "a) Signing a declaration regarding:",
          "- No health contraindications",
          "- Familiarity with safety rules",
          "- Acceptance of responsibility for potential damages",
          "b) Reading safety instructions",
          "c) Completing equipment usage training",
          "d) Putting on complete protective equipment",
          "6.2. Required protective equipment:",
          "a) Protective coverall (provided by Service Provider)",
          "b) Helmet with visor (provided by Service Provider)",
          "c) Protective gloves (provided by Service Provider)",
          "d) Closed-toe shoes (own)",
          "6.3. Absolute prohibitions:",
          "a) Being under the influence of alcohol or intoxicants",
          "b) Bringing own items for destruction",
          "c) Destroying equipment not designated for smashing",
          "d) Removing protective equipment during session",
          "e) Aggressive behavior towards staff or other participants",
          "6.4. Health contraindications:",
          "a) Pregnancy",
          "b) Cardiovascular diseases",
          "c) Epilepsy",
          "d) Musculoskeletal disorders",
          "e) Other medical conditions that may pose a risk",
          "6.5. Staff authority:",
          "a) Verification of participants' sobriety",
          "b) Session termination in case of rule violations",
      ...
      liability: {
        title: "7. Liability",
        content: [
          "7.1. Service Provider's responsibility:",
          "a) Providing functional protective equipment",
          "b) Maintaining safe conditions during sessions",
          "c) Civil liability insurance coverage",
          "d) Staff training in first aid",
          "7.2. Service Provider is not liable for:",
          "a) Damages resulting from non-compliance with regulations",
          "b) Damages resulting from non-compliance with staff instructions",
          "c) Damage or soiling of participant's own clothing",
          "d) Lost or left personal belongings",
          "e) Damages resulting from concealment of health contraindications",
          "7.3. Participant's responsibility:",
          "a) Covering costs of intentionally caused damages",
          "b) Following safety rules",
          "c) Following staff instructions",
          "d) Accuracy of provided health information",
          "7.4. Property damage:",
          "a) Destruction of equipment not designated for smashing - full repair/replacement cost",
          "b) Damage to protective equipment - according to price list",
      ...
      final: {
        ...
        content: [
          "8.1. These Terms and Conditions come into force on January 1, 2025.",
          "8.2. Any disputes will be resolved amicably, and in case of no agreement, by the court having jurisdiction over the Service Provider's registered office.",
          "8.3. Complaints:",
          "a) Must be submitted in writing via email or mail",
          "b) Processing time - 14 business days",
          "c) Required complaint elements:",
          "- Contact details",
          "- Reservation number",
          "- Situation description",
          "- Expected resolution",
          "8.4. Personal data:",
          "a) Data controller is Smashandfun Sp. z o.o.",
          "b) Processing in accordance with Privacy Policy",
          "c) Processing purpose - service provision and marketing",
          "8.5. Communication:",
