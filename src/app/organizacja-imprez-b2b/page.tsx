...
import { Calendar, Users, CheckCircle, ArrowRight, Send, Briefcase, Award, Layers } from 'lucide-react';
        ...
        <section className="w-full bg-[#231f20] py-20 pb-32 relative" id="contact-form" ref={formRef}>
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10">
            ...
            <motion.div
              ...
              animate={isFormInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
              transition={{ duration: 0.7, ease: "easeOut", delay: 0.2 }}
              className="bg-gradient-to-b from-[#1a1718] to-[#231f20] rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(243,110,33,0.1)] border border-white/5 p-8 md:p-10 relative"
            >
              {/* Success message */}
              {isSuccess && (
                <motion.div 
                ...
                <div>
                  <motion.button
                    ...
                    className="group relative overflow-hidden px-8 py-4 bg-[#f36e21] text-white font-bold rounded-lg
                      ...
                      focus:outline-none focus:ring-2 focus:ring-[#f36e21] focus:ring-opacity-50 disabled:opacity-70 flex items-center"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent 
                                  translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                    <Send className="w-5 h-5 mr-2" />
                    {isSubmitting ? t('b2b.form.sending') : t('b2b.form.submit')}
